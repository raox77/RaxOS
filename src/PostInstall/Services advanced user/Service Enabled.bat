...
REN "C:\Windows\SystemApps\ShellExperienceHost_cw5n1h2txyewy\ShellExperienceHost.old" "ShellExperienceHost.exe" 
reg add "HKLM\SYSTEM\CurrentControlSet\Services\Schedule" /v "ErrorControl" /t REG_DWORD /d "1" /f 
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\kdnic" /v "Start" /t REG_DWORD /d "3" /f 
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\WUDFWpdFs" /v "Start" /t REG_DWORD /d "3" /f 
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\clreg" /v "Start" /t REG_DWORD /d "3" /f 
reg add "HKLM\SYSTEM\CurrentControlSet\Services\srv" /v "Start" /t REG_DWORD /d "2" /f 
reg add "HKLM\SYSTEM\CurrentControlSet\Services\srv2" /v "Start" /t REG_DWORD /d "3" /f 
reg add "HKLM\SYSTEM\CurrentControlSet\Services\srvnet" /v "Start" /t REG_DWORD /d "3" /f 
reg add "HKLM\SYSTEM\CurrentControlSet\Services\ajrouter" /v "Start" /t REG_DWORD /d "3" /f 
